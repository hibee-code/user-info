...
export class Sh1734122916546 implements MigrationInterface {
    name = 'Sh1734122916546'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_info" ADD CONSTRAINT "FK_0abd165af6adcac4bffc8eb2585" FOREIGN KEY ("contactId") REFERENCES "user_contact"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_info" ADD CONSTRAINT "FK_917dca91af4d24821a88ab0bbdd" FOREIGN KEY ("addressId") REFERENCES "user_address"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
